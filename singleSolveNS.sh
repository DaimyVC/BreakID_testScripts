...
{ time cat $instances/${filename}.${extension} | $home/roundingsatV1 --lp=1 --opt-mode=linear 1>$TMPDIR/${filename}_${config}_rs.txt ; } 2>$TMPDIR/${filename}_${config}_rstime.txt
